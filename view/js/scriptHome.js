// webservice/view/js/scriptHome.js
...
async function carregarSessões() {
    ...
    try {
        ...
        sessoes.forEach(sessao => {
            ...
            col.innerHTML = `
                <div class="card h-100 border rounded overflow-hidden">
                    <img src="assets/images/cine.webp" class="card-img-top" alt="${sessao.nome_filme}">
        ...
        // ao clicar em "Cadastrar Compra", redireciona com sessão e horário pré-selecionados
    ...
    const sessaoSelecionada = {
        id_sessao: id_sessao,
        id_filme: sessoes.find(s => String(s.id_sessao) === String(id_sessao)).id_filme,
        horario: horario,
